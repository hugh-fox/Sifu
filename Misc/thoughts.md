...
- Compile fast and run fast. Either of these missing is a sign of too much complexity.
...
lambda calculus and immutablility both are independent from sets.
